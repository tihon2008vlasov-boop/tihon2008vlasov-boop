...
<!-- Static typewriter-style headline -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&duration=1&pause=100000&repeat=false&color=000000&center=true&vCenter=true&width=700&lines=Full-Stack+Developer+%7C+Building+AI+Products+%7C+Vibe-coding" />
</p>
...
const kaimory = {
  ...
  focus: ["AI Products", "Vibe-coding", "Hackathons"],
  currentGoal: "Moving to the USA",
  philosophy: "Build fast, ship faster, let AI handle the boring parts",
  weapon_of_choice: ["React", "Next.js", "Python", "FastAPI"],
};
```
