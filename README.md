...
const kaimory = {
  ...
  currentGoal: "Переезд в США",
  philosophy: "Build fast, ship faster, let AI handle the boring parts",
  weapon_of_choice: ["React", "Next.js", "Python", "FastAPI"],
};
```

- Разрабатываю AI-продукты, от идеи до продакшена
- Активно вайбкожу — быстрая разработка вместе с AI-инструментами (Claude, Cursor, Copilot)
